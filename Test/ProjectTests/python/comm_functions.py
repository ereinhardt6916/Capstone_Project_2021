def startup(socket1, socket2):
    ...
    if (colour1 == colour2) or (colour1 == b"Whit"):
        ...
        print("Writing S1:" + b"1111Blac".decode("utf-8") )
        socket1.send_data(b"1111Blac")

        
        print("Writing S2:" + b"0000Whit".decode("utf-8") )
        socket2.send_data(b"0000Whit")
